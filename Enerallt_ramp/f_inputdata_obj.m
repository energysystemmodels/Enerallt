...
% p: production
%--------------------------------------------------------------------------------------------------
classdef f_inputdata_obj
    properties
        input_file, n_region, El_dem_hh, P_pow,Ramp, Eff_el, Emm_fac, El_chp_ind_hh, El_pro_fix_hh,...
        El_pro_nuc_r, Dd_hob_hh, Dd_chp_ind_hh, Dd_chp1_hh, Dd_chp2_hh, Chp_ind_hh, P_chp, P_chp1,...
        Eff_el_chp1, Eff_el_chp2, Eff_th_chp1, Eff_th_chp2, Eff_chp_boil, Eff_hob, Pth_chp, F_hob_r,...
        F_chp1_r, F_chp2_r, F_boil_r, P_hp_chp1, P_hp_chp2, Cop_hp_chp1, Cop_hp_chp2, T_chp_boil,...
        Chp_boil_fix, St_chp1, St_chp2, Dp_sol_hob, Dp_sol_chp1, Dp_sol_chp2, Dp_sol_hob_r, Dp_sol_chp1_r,...
        Dp_sol_chp2_r, St_sol_hob, St_sol_chp1, St_sol_chp2, Loss_sol_hob, Loss_sol_chp1, Loss_sol_chp2,... 
        Cf_pv, Cf_wind, Cf_windoff, Pv_hh, Wind_hh, Hyd_res_hh, Hyd_infl_hh, El_rivhyd_pro, Nuc_hh,...
        Hyd_res_dd, Hyd_infl_dd, St_hyd, Cost_hyd_corr, Wv_seg,Cost_wv, Cost_hyd_coff, St_begin, St_min,...
        Name_r, Name_p, Name_chp, Ntc, Market_exch, Cost_p, Cost_chp1_mc, Cost_chp2_mc, Cost_ppchp2_mc,...
        Cost_r, Cost_seg, Area_p_his_hh, Sys_p_his_hh
    end
    methods
        function obj = f_inputdata_obj(filename,n_region)       % 'Input_data.mat'
            obj.input_file = load(filename);
            ...
            obj.El_chp_ind_hh=repmat(Ep_chp_ind.*1e6,n_hour,1).*repmat(Chp_ind_hh./sum(Chp_ind_hh),1,obj.n_region);
