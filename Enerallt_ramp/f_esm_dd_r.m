...
%--------------------------------------------------------------------------------
function[Ntc,Market_exch,El_dem_tot,El_dem_res_tot,Ramp,Eff_el,Emm_fac,Eff_el_chp1,Eff_el_chp2,Eff_chp_boil,Eff_hob,....
    ...
    Cost_chp1_pool,Cost_chp2_pool,Cost_p,Cost_r,Cost_seg,Name_pool,Name_r]=f_esm_dd_r(n_sys,th_1,th_n)

nh=th_n-th_1+1;        % Number of hours in the analysis

[El_dem_hh,P_pow,Ramp,Eff_el,Emm_fac,El_chp_ind_hh,El_pro_fix_hh,El_pro_nuc_r,...
 ...
 Name_r,Name_p,Name_chp,Ntc,Market_exch,Cost_p,Cost_chp1_mc,Cost_chp2_mc,Cost_ppchp2_mc,Cost_r,Cost_seg]=f_inputdata_r(n_sys);
