...
% p: production
%--------------------------------------------------------------------------------------------------
function [El_dem_hh,P_pow,Eff_el,Emm_fac,El_chp_ind_hh,El_pro_fix_hh,El_pro_nuc_r,...
 ...
 Name_r,Name_p,Name_chp,Ntc,Market_exch,Cost_p,Cost_chp1_mc,Cost_chp2_mc,Cost_ppchp2_mc,Cost_r,Cost_seg]=f_inputdata(n_tot)
